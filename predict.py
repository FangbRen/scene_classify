...
caffe_model_path = '/home/fangbo/caffe/examples/lmdb_img/resnet_iter_2200.caffemodel'
...
for img in imgfile:
    ...
    #print(top_inds)
    dic = {"image_id":img[0],"lable_id":top_inds}
    a.append(dic)

#ImageId=[i+1 for i in range(n)]
pre_json = json.dumps(a)

with open(path + 'examples/lmdb_img/pre_json.json','w') as f:
    #json.dump(a,f)
    f.write(pre_json)
    f.close()